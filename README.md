...
**Status (2.3.49): braking is detected. Tuning out road noise.**

The mechanism turned out to be the **high-pass filter**, not the threshold. Three versions settled it:
...
- **2.3.49** drops `ZHIE`, because the lower cutoff also let road-surface vertical jolts through — `hcnt` reached 12 in eight minutes of ordinary driving.
